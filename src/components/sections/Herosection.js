  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/avatar-1.svg" alt="manikandan" width='150' className="mb-4" />

          <h1 className="mb-2 mt-0 text-uppercase">Manikandan . R</h1>
          <h1 className="mb-2 mt-0 fs-3">UI/UX and Front-End Developer</h1>
          <p>
            Well Known as{" "}
            <Typed
              strings={[
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a target="_blank" href="https://www.linkedin.com/in/manikandan-r-052aa6198">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a target="_blank" href="https://twitter.com/Manikan67445619?s=09">
